  ...
  <body>
    ...
    <main>
      <section class="presentacion">
        <div
          ...
          class="carousel slide presentacion-carrousel"
          ...
          <div class="row">
             ...
             <div class="col-12 col-md-6 col-lg-3">
              <div class="promocion-index">
                <img src="../Images/Local1.jpg" alt="Proyecto 2" />
                <div class="overlay">
           ...
           <div class="col-12 col-md-6 col-lg-3">
              <div class="promocion-index">
                <img src="../Images/Local2.jpg" alt="Proyecto 2" />
                <div class="overlay">
                  <p>Haz clic para ver las promociones de ...</p>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
              <div class="promocion-index">
                <img src="../Images/Local3.jpg" alt="Proyecto 2" />
                <div class="overlay">
                  <p>Haz clic para ver las promociones de ...</p>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
              <div class="promocion-index">
                <img src="../Images/Local4.jpg" alt="Proyecto 2" />
                <div class="overlay">
                  <p>Haz clic para ver las promociones de ...</p>
                </div>
              </div>
      ...
      <section id="promociones" class="promociones seccion-oscura">
        ...
        <div class="container text-center proyectos-contenedor">
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="promocion-index">
                <img src="../Images/Promocion2.jpg" alt="Proyecto 2" />
                <div class="overlay">
                  <p>Nombre promocion</p>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="promocion-index">
                <img src="../Images/Promocion3.jpg" alt="Proyecto 3" />
                <div class="overlay">
                  <p>Nombre promocion</p>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="promocion-index">
                <img src="../Images/Promocion4.jpg" alt="Proyecto 3" />
                <div class="overlay">
                  <p>Nombre promocion</p>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="promocion-index">
                <img src="../Images/Promocion5.jpg" alt="Proyecto 3" />
                <div class="overlay">
                  <p>Nombre promocion</p>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="promocion-index">
                <img src="../Images/Promocion6.jpg" alt="Proyecto 3" />
                <div class="overlay">
                  <p>Nombre promocion</p>
                </div>
              </div>
    ...
    <section class="mapa-google">
      ...
      <div class="mapa-container">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3593.617347374075!2d-80.263616524057!3d25.750164909080794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d9ba2ed5cfe615%3A0xad638083c8eb0c89!2sViventa%20Miami!5e0!3m2!1ses-419!2sar!4v1750373072030!5m2!1ses-419!2sar"
          width="100%"
          height="100%"
          style="border: 0"
          allowfullscreen=""
    ...
    >
      <div class="container d-flex flex-wrap justify-content-center gap-5 px-0">
        ...
        <nav class="texto-footer">
          ...
          <div class="mb-2"><a href="#locales">Locales</a></div>
          <div class="mb-2"><a href="#promociones">Promociones</a></div>
          <div class="mb-2"><a href="#novedades">Novedades</a></div>
