...
<html lang="es">
  ...
  <body>
    ...
    <main class="FondoDueñoAdministrador">
          ...
          <div class="promocion">
            ...
            <div class="acciones-reporte align-items-center d-flex justify-content-center acciones">
                ...
                <form method="POST" style="display:inline;">
                    ...
                    <button type="submit" class="btn btn-danger" style="padding: 18px 18px;" onclick="return confirm('¿Seguro que quieres Rechazar esta solicitud?');">RECHAZAR</button>
                </form>
            </div>
          </div>
           <?php endwhile; ?>
        ...
        <?php else: ?>
           <h3>No hay solicitudes pendientes para sus locales.</h3>
        <?php endif; ?>
      </main>
